...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '独自赏晴雨', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '正在努力变强', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog-one-beryl-14.vercel.app', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '渔业遥感, 博客', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://raw.githubusercontent.com/FC-Han/image/main/icon111.jpg', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
